							...
							<table class="table w-full">
								...
								<c:forEach var="adminPageSearchNotice" items="${adminPageSearchNoticeList}">
									<tr>
										...
										<td class="justify-center items-center text-center">
											<fmt:parseDate value="${adminPageSearchNotice.writeDate}" pattern="yyyy-MM-dd'T'HH:mm:ss" var="parsedDateTime" type="both" />
										...
										<td>
											<label for="editNotice${adminPageSearchNotice.noticeNo}" class="modal-button cursor-pointer">
										...
										<td>
											<label for="deleteNotice${adminPageSearchNotice.noticeNo}" class="modal-button cursor-pointer">
									...
									<%--삭제 모달--%>
									<input type="checkbox" id="deleteNotice${adminPageSearchNotice.noticeNo}" class="modal-toggle"/>
											...
											<div class="flex flex-col py-20 text-center">
												...
												<c:if test="${!empty admInfo}">
													<div id="passCheckForDeleteNotice" class="form-control flex flex-row mx-auto space-x-2 my-4">
														...
														<button type="button" class="btn btn-secondary hover:bg-purple-600 hover:text-white w-24 bg-gray-200 border-gray-200 text-black" onClick="adminPassCheckBtn(${admInfo.admPass}, ${adminPageSearchNotice.noticeNo})">비밀번호 확인</button>
													</div>
												</c:if>
											</div>
										</div>
