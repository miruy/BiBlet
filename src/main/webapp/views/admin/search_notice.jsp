    ...
    <div class="flex flex-col justify-center bg-white p-10">
        ...
        <div id="tab_content_group" class="px-10 py-8 my-4 w-full rounded-2xl shadow-2xl bg-gray-100 admin_font">
            ...
            <div id="noticeManagement">
                ...
                <form class="flex flex-row justify-center" name="requestNoticeSearch" method="post"
                      action="/admin/supervise_notice">
                    ...
                    <div class="relative w-96">
                        ...
                        <input type="text" name="keyword" id="keyword" value="${keyword}"
                               class="input input-bordered text-gray-900 text-sm p-7 pl-10 w-full"
                               placeholder="공지사항 검색"/>
                        <input type="submit" id="noticeSearch" value="검색"
                               class="text-white absolute right-2.5 bottom-2.5 top-2.5 text-sm font-medium text-gray-600 hover:text-white btn-secondary w-16 h-10 rounded-lg"/>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="flex flex-row space-x-2">
                                <div class="ml-2">검색 공지사항 수 :</div>
                                <div>${searchNoticeCount}</div>
                            </div>

                            <button class="btn btn-sm btn-secondary text-white hover:text-white mr-2 mb-2"
                                    onclick="location.href='/admin/writeNotice'">공지사항 작성
                            </button>
                        </div>
                        ...
                        <c:if test="${!empty adminPageSearchNoticeList}">
                            <table class="table w-full">
                                ...
                                <tbody>
                                <c:forEach var="adminPageSearchNotice" items="${adminPageSearchNoticeList}">
                                    <tr>
                                        <td class="justify-center items-center text-center">
                                                ${adminPageSearchNotice.noticeNo}
                                        </td>
                                        <td class="justify-center items-center text-center">
                                                ${adminPageSearchNotice.writer}
                                        </td>
                                        <td class="justify-center items-center text-center">
                                            <a href="/admin/notice_${adminPageSearchNotice.noticeNo}">${adminPageSearchNotice.title}</a>
                                        </td>
                                        <td class="justify-center items-center text-center">
                                            <fmt:parseDate value="${adminPageSearchNotice.writeDate}"
                                                           pattern="yyyy-MM-dd'T'HH:mm:ss" var="parsedDateTime"
                                                           type="both"/>
                                            <fmt:formatDate pattern="yyyy-MM-dd" value="${ parsedDateTime }"/>
                                        </td>
                                        <td class="justify-center items-center text-center">
                                                ${adminPageSearchNotice.count}
                                        </td>
                                        <td>
                                            <a id="editNotice${adminPageSearchNotice.noticeNo}" href="/admin/modifyNotice_${adminPageSearchNotice.noticeNo}">
                                                <svg class="w-10 h-10 ml-11" height="21" viewBox="0 0 21 21" width="21"
                                                     xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <label for="deleteNotice${adminPageSearchNotice.noticeNo}"
                                                   class="modal-button cursor-pointer">
                                                <svg class="w-8 h-8 ml-11" viewBox="0 0 32 32"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <defs>
                                                        <style>.cls-1 {
                                                            fill: #101820;
                                    ...
                                    <%--삭제 모달--%>
                                    <input type="checkbox" id="deleteNotice${adminPageSearchNotice.noticeNo}"
                                           class="modal-toggle"/>
                                        ...
                                        <div class="modal-box relative h-2/3 w-5/6 max-w-xl">
                                            ...
                                            <div class="flex flex-col py-20 text-center">
                                                ...
                                                <c:if test="${!empty admInfo}">
                                                    <div id="passCheckForDeleteNotice"
                                                        ...
                                                        <button type="button"
                                                                ...
                                                                onClick="adminPassCheckBtn(${admInfo.admPass}, ${adminPageSearchNotice.noticeNo})">
                                                            비밀번호 확인
                                                        </button>
                                                    </div>
                                                </c:if>
