                        ...
                        <table class="table w-full text-center">
                            ...
                            <c:if test="${!empty searchList}">
                                <c:forEach var="searchUser" items="${searchList}">
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${searchUser.storedPic ne null}">
                                                ...
                                                <c:if test="${idSub ne 'kakao'}">
                                                    <img src="<c:url value='/images/${searchUser.storedPic}'/>"
                                                         class="mask mask-circle w-10 h-10 ml-2"/>
                                                </c:if>
                                                <c:if test="${idSub eq 'kakao'}">
                                                    <img src="<c:url value='http://${searchUser.storedPic}'/>"
                                                         class="mask mask-circle w-10 h-10 ml-2"/>
                                                </c:if>
                                            </c:if>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${idSub eq 'kakao'}">
                                                <textarea rows="1" class="w-14 bg-white resize-x"
                                                          disabled>${searchUser.pass}</textarea>
                                            </c:if>
                                        </td>
                                        <td>
                                            <c:set var="idSub" value="${fn:substring(searchUser.id,0,5)}"/>
                                            ...
                                            <c:if test="${idSub eq 'kakao'}">
                                                <textarea rows="1" class="w-24 bg-white resize-x"
                                                          disabled>${searchUser.email}</textarea>
                                            </c:if>
                                        </td>
                                        <td>
                                            <fmt:parseDate value="${searchUser.regDate}" pattern="yyyy-MM-dd'T'HH:mm:ss"
                                    ...
                                    <%--강제 탈퇴 모달--%>
                                    <input type="checkbox" id="forcedWithdraw${searchUser.userNo}"
                                           class="modal-toggle"/>
