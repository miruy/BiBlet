                            ...
                            <table class="table w-full">
                                ...
                                <c:forEach var="allNotice" items="${allNoticeList}">
                                    <tr>
                                        ...
                                        <td class="justify-center items-center text-center">
                                            <fmt:parseDate value="${allNotice.writeDate}"
                                        ...
                                        <td>
                                            <a id="editNotice${allNotice.noticeNo}" href="/admin/modifyNotice_${allNotice.noticeNo}">
                                                <svg class="w-10 h-10 mx-auto" height="21" viewBox="0 0 21 21" width="21"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <c:if test="${!empty admInfo}">
                                                    <div id="passCheckForDeleteNotice"
                                                        ...
                                                        <button type="button"
                                                                ...
                                                                onClick="adminPassCheckBtn(${admInfo.admPass}, ${allNotice.noticeNo})">
                                                            비밀번호 확인
                                                        </button>
                                                    </div>
                                                </c:if>
