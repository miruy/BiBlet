					...
					<div class="overflow-x-auto">
						...
						<table class="table w-full text-center">
							...
							<tr class="hover">
								...
								<td>
									<label for="forcedWithdraw${user.userNo}" class="modal-button cursor-pointer">
										...
										<div class="flex flex-col py-20 text-center">
											...
											<c:if test="${!empty admInfo}">
													<div id="forcedWithdraw" class="form-control flex flex-row mx-auto space-x-2 my-4">
														...
														<button type="button" class="btn btn-secondary hover:bg-purple-600 hover:text-white w-24 bg-gray-200 border-gray-200 text-black" onClick="adminPassCheckBtn(${admInfo.admPass}, ${user.userNo})">비밀번호 확인</button>
													</div>
											</c:if>
										</div>
									</div>
