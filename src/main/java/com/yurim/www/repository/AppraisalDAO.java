...
public interface AppraisalDAO {
	...
	Integer userStar(HashMap<String, String> map);	//해당 도서의 대한 회원의 평점
	void insertStar(HashMap<String, Long> map);	//평점 등록
	void updateStar(AppraisalDTO appraisal);	//평점 수정
	void deleteStar(HashMap<String, String> map);	//평점 삭제
	...
	void deleteComment(HashMap<String, String> map);	//평가 삭제
}
